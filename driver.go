...
type IDriver interface {
	CreateViewport(width, height int, name string) (IViewport, error)
	Terminate()
}
...
type DriverFuncs struct {
	...
	WaitEvents     func()
	Wake           func()
	CreateViewport func(width, height int, name string) (IViewport, error)
}
...
func (d *driver) CreateViewport(width, height int, name string) (IViewport, error) {
	...
	var err error
	d.syncDriver(func() {
		v, err = d.driverFuncs.CreateViewport(width, height, name)
	})
	return v, err
}
